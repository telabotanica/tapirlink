  ...
  <body>
    ...
    <table border="0" cellspacing="1" cellpadding="3" bgcolor="#999999">
      <tr bgcolor="#FFFFFF">
        ...
        <th align="center" bgcolor="#FFFFFF"><b>RSS link</b></th>
      </tr>
      <xsl:for-each select="tapir:response/tapir:inventory/tapir:record">
      <tr bgcolor="#FFFFFF">
        <td align="left"><a href="{$accesspoint}?op=s&amp;xslt={$base-url}skins/{$skin}/search.xsl&amp;s=0&amp;l=20&amp;cnt=1&amp;e=1&amp;f={$concept-id}%20equals%20%22{tapir:value}%22&amp;m={$base-url}skins/default/model.xml.php%3Fc%3D{$concept-id}%26v%3D{tapir:value}%26a%3D{$accesspoint}"><xsl:value-of select="tapir:value"/></a></td>
        <td align="center"><xsl:value-of select="@count"/></td>
        <td align="center"><a href="{$accesspoint}?op=s&amp;s=0&amp;l=20&amp;e=0&amp;t={$base-url}skins/{$skin}/rss_template.xml.php%3Fc%3D{$concept-id}&amp;v={tapir:value}">rss</a></td>
      </tr>
      </xsl:for-each>
    </table>
